const CACHE_VERSION = "20260825-070652";
...
const urlsToCache = [
  ...
  '/index.html',
  '/offline.html',
  'Imagens_autorais/cirurgiao-svg.svg',
  'Imagens_autorais/consulta-enfermeiro-svg.svg',
  'Imagens_autorais/enfermeira-de-mascara-azul.svg',
  ...
  'automacoes/biblioteca_doencas_notificacao_compulsoria.json',
  'automacoes/catalogador/catalogador_cache.json',
  'automacoes/contar-itens.js',
  ...
  'automacoes/traducao_glossario.json',
  ...
  'img/seringa_insulina_U100_infografico_VETORIAL.svg',
  'img/seringa_insulina_u100_interativa_corrigida_v2.svg',
  'it/favicon.ico',
  'ja/favicon.ico',
  'js/accessibility.js',
