...
def _layer_spec() -> dict[str, dict]:
    ...
    return {
        ...
        "L120": {
            ...
            "md_implemented": False,
            "reg_population": "HOLD",
            "evidence": ["cko_md/nnn_rights_architecture.json"],
            "identities": ["MD-NNN-RIGHTS-001"],
            "reg_instruments": [],
            "gap": "nanda-00046.json QUARANTINE. Sem texto licenciado.",
        ...
        "L310": {
            ...
            "md_implemented": False,
            "reg_population": "HOLD",
            "evidence": ["cko_md/who_i18n_modulation.json", "cko_reg/i18n_profile.json"],
            "identities": ["who.en+local.pt-BR", "MD-WHO-I18N-001"],
            "reg_instruments": ["FLD-I18N-WHO-LOCAL-KEY"],
            "gap": "translation_gate HOLD. Variantes lusófonas catalogadas, não ligadas.",
            "do_not": "Inferir pt→pt-BR. Dump ICD/ICNP/GHO.",
