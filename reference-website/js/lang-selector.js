...
(function () {
  ...
  var LANGUAGES = [
    { code: "pt-BR", native: "Português (Brasil)", short: "PT", flag: "br.svg" },
    { code: "en",    native: "English",             short: "EN", flag: "us.svg" },
    { code: "es",    native: "Español",             short: "ES", flag: "es.svg" },
    { code: "fr",    native: "Français",            short: "FR", flag: "fr.svg" },
    { code: "de",    native: "Deutsch",              short: "DE", flag: "de.svg" },
    { code: "it",    native: "Italiano",             short: "IT", flag: "it.svg" },
    { code: "nl",    native: "Nederlands",           short: "NL", flag: "nl.svg" },
    { code: "pl",    native: "Polski",               short: "PL", flag: "pl.svg" },
    { code: "ru",    native: "Русский",              short: "RU", flag: "ru.svg" },
    { code: "tr",    native: "Türkçe",               short: "TR", flag: "tr.svg" },
    { code: "ar",    native: "العربية",              short: "AR", flag: "sa.svg" },
    { code: "he",    native: "עברית",                short: "HE", flag: "il.svg" },
    { code: "hi",    native: "हिन्दी",                short: "HI", flag: "in.svg" },
    { code: "bn",    native: "বাংলা",                 short: "BN", flag: "bd.svg" },
    { code: "zh-CN", native: "中文（简体）",           short: "ZH", flag: "cn.svg" },
    { code: "zh-TW", native: "中文（繁體）",           short: "ZH", flag: "tw.svg" },
    { code: "ja",    native: "日本語",                short: "JA", flag: "jp.svg" },
    { code: "ko",    native: "한국어",                short: "KO", flag: "kr.svg" },
    { code: "vi",    native: "Tiếng Việt",           short: "VI", flag: "vn.svg" },
    { code: "th",    native: "ไทย",                  short: "TH", flag: "th.svg" },
    { code: "id",    native: "Bahasa Indonesia",     short: "ID", flag: "id.svg" },
    { code: "ms",    native: "Bahasa Melayu",        short: "MS", flag: "my.svg" },
    { code: "tl",    native: "Filipino",             short: "TL", flag: "ph.svg" },
    { code: "sw",    native: "Kiswahili",            short: "SW", flag: "ke.svg" },
    { code: "am",    native: "አማርኛ",                 short: "AM", flag: "et.svg" },
    { code: "el",    native: "Ελληνικά",             short: "EL", flag: "gr.svg" },
    { code: "ro",    native: "Română",               short: "RO", flag: "ro.svg" },
    { code: "hu",    native: "Magyar",               short: "HU", flag: "hu.svg" },
    { code: "cs",    native: "Čeština",              short: "CS", flag: "cz.svg" },
    { code: "sv",    native: "Svenska",              short: "SV", flag: "se.svg" }
  ];
  ...
  var COUNTRIES = {
    americas: [
      { country: "Brasil", code: "pt-BR", flag: "br.svg" },
      { country: "Estados Unidos", code: "en", flag: "us.svg" },
      { country: "Canadá", code: "en", flag: "ca.svg" },
      { country: "México", code: "es", flag: "mx.svg" },
      { country: "Argentina", code: "es", flag: "ar.svg" },
      { country: "Colômbia", code: "es", flag: "co.svg" },
      { country: "Chile", code: "es", flag: "cl.svg" },
      { country: "Peru", code: "es", flag: "pe.svg" },
      { country: "Equador", code: "es", flag: "ec.svg" },
      { country: "Venezuela", code: "es", flag: "ve.svg" },
      { country: "Uruguai", code: "es", flag: "uy.svg" },
      { country: "Paraguai", code: "es", flag: "py.svg" },
      { country: "Bolívia", code: "es", flag: "bo.svg" },
      { country: "Costa Rica", code: "es", flag: "cr.svg" },
      { country: "Panamá", code: "es", flag: "pa.svg" },
      { country: "Guatemala", code: "es", flag: "gt.svg" },
      { country: "Cuba", code: "es", flag: "cu.svg" },
      { country: "Rep. Dominicana", code: "es", flag: "do.svg" },
      { country: "Honduras", code: "es", flag: "hn.svg" },
      { country: "Nicarágua", code: "es", flag: "ni.svg" },
      { country: "El Salvador", code: "es", flag: "sv.svg" },
      { country: "Haiti", code: "fr", flag: "ht.svg" },
      { country: "Jamaica", code: "en", flag: "jm.svg" },
      { country: "Trinidad e Tobago", code: "en", flag: "tt.svg" },
      { country: "Bahamas", code: "en", flag: "bs.svg" },
      { country: "Barbados", code: "en", flag: "bb.svg" },
      { country: "Granada", code: "en", flag: "gd.svg" },
      { country: "Suriname", code: "nl", flag: "sr.svg" },
      { country: "Guiana", code: "en", flag: "gy.svg" },
      { country: "Belize", code: "en", flag: "bz.svg" },
      { country: "Santa Lúcia", code: "en", flag: "lc.svg" },
      { country: "Dominica", code: "en", flag: "dm.svg" },
      { country: "Antígua e Barbuda", code: "en", flag: "ag.svg" },
      { country: "São Cristóvão e Névis", code: "en", flag: "kn.svg" },
      { country: "São Vicente e Granadinas", code: "en", flag: "vc.svg" },
    ],
    europa: [
      { country: "Portugal", code: "pt-BR", flag: "pt.svg" },
      { country: "Espanha", code: "es", flag: "es.svg" },
      { country: "França", code: "fr", flag: "fr.svg" },
      { country: "Bélgica", code: "fr", flag: "be.svg" },
      { country: "Alemanha", code: "de", flag: "de.svg" },
      { country: "Áustria", code: "de", flag: "at.svg" },
      { country: "Suíça", code: "de", flag: "ch.svg" },
      { country: "Itália", code: "it", flag: "it.svg" },
      { country: "Países Baixos", code: "nl", flag: "nl.svg" },
      { country: "Polônia", code: "pl", flag: "pl.svg" },
      { country: "Rússia", code: "ru", flag: "ru.svg" },
      { country: "Grécia", code: "el", flag: "gr.svg" },
      { country: "Romênia", code: "ro", flag: "ro.svg" },
      { country: "Hungria", code: "hu", flag: "hu.svg" },
      { country: "Rep. Tcheca", code: "cs", flag: "cz.svg" },
      { country: "Suécia", code: "sv", flag: "se.svg" },
      { country: "Noruega", code: "sv", flag: "no.svg" },
      { country: "Dinamarca", code: "sv", flag: "dk.svg" },
      { country: "Finlândia", code: "sv", flag: "fi.svg" },
      { country: "Irlanda", code: "en", flag: "ie.svg" },
      { country: "Reino Unido", code: "en", flag: "uk.svg" },
      { country: "Ucrânia", code: "ru", flag: "ua.svg" },
      { country: "Bulgária", code: "ru", flag: "bg.svg" },
      { country: "Croácia", code: "en", flag: "hr.svg" },
      { country: "Sérvia", code: "en", flag: "rs.svg" },
      { country: "Eslováquia", code: "cs", flag: "sk.svg" },
      { country: "Eslovênia", code: "en", flag: "si.svg" },
      { country: "Lituânia", code: "en", flag: "lt.svg" },
      { country: "Letônia", code: "en", flag: "lv.svg" },
      { country: "Estônia", code: "en", flag: "ee.svg" },
      { country: "Luxemburgo", code: "fr", flag: "lu.svg" },
      { country: "Malta", code: "en", flag: "mt.svg" },
      { country: "Chipre", code: "el", flag: "cy.svg" },
      { country: "Islândia", code: "en", flag: "is.svg" },
      { country: "Albânia", code: "en", flag: "al.svg" },
      { country: "Bósnia e Herzegovina", code: "en", flag: "ba.svg" },
      { country: "Moldávia", code: "ro", flag: "md.svg" },
      { country: "Macedônia do Norte", code: "en", flag: "mk.svg" },
      { country: "Montenegro", code: "en", flag: "me.svg" },
      { country: "Andorra", code: "es", flag: "ad.svg" },
      { country: "Mônaco", code: "fr", flag: "mc.svg" },
      { country: "Liechtenstein", code: "de", flag: "li.svg" },
      { country: "San Marino", code: "it", flag: "sm.svg" },
      { country: "Vaticano", code: "it", flag: "va.svg" },
      { country: "Belarus", code: "ru", flag: "by.svg" },
      { country: "Geórgia", code: "en", flag: "ge.svg" },
      { country: "Armênia", code: "ru", flag: "am.svg" },
      { country: "Azerbaijão", code: "ru", flag: "az.svg" },
      { country: "Kosovo", code: "en", flag: "xk.svg" },
    ],
    asia: [
      { country: "Índia", code: "hi", flag: "in.svg" },
      { country: "Bangladesh", code: "bn", flag: "bd.svg" },
      { country: "China", code: "zh-CN", flag: "cn.svg" },
      { country: "Taiwan", code: "zh-TW", flag: "tw.svg" },
      { country: "Japão", code: "ja", flag: "jp.svg" },
      { country: "Coreia do Sul", code: "ko", flag: "kr.svg" },
      { country: "Coreia do Norte", code: "ko", flag: "kp.svg" },
      { country: "Vietnã", code: "vi", flag: "vn.svg" },
      { country: "Tailândia", code: "th", flag: "th.svg" },
      { country: "Indonésia", code: "id", flag: "id.svg" },
      { country: "Malásia", code: "ms", flag: "my.svg" },
      { country: "Filipinas", code: "tl", flag: "ph.svg" },
      { country: "Cingapura", code: "en", flag: "sg.svg" },
      { country: "Austrália", code: "en", flag: "au.svg" },
      { country: "Nova Zelândia", code: "en", flag: "nz.svg" },
      { country: "Paquistão", code: "en", flag: "pk.svg" },
      { country: "Sri Lanka", code: "en", flag: "lk.svg" },
      { country: "Camboja", code: "en", flag: "kh.svg" },
      { country: "Mianmar", code: "en", flag: "mm.svg" },
      { country: "Laos", code: "en", flag: "la.svg" },
      { country: "Mongólia", code: "en", flag: "mn.svg" },
      { country: "Nepal", code: "hi", flag: "np.svg" },
      { country: "Butão", code: "en", flag: "bt.svg" },
      { country: "Maldivas", code: "en", flag: "mv.svg" },
      { country: "Afeganistão", code: "en", flag: "af.svg" },
      { country: "Irã", code: "ar", flag: "ir.svg" },
      { country: "Iraque", code: "ar", flag: "iq.svg" },
      { country: "Síria", code: "ar", flag: "sy.svg" },
      { country: "Líbano", code: "ar", flag: "lb.svg" },
      { country: "Jordânia", code: "ar", flag: "jo.svg" },
      { country: "Iêmen", code: "ar", flag: "ye.svg" },
      { country: "Omã", code: "ar", flag: "om.svg" },
      { country: "Kuwait", code: "ar", flag: "kw.svg" },
      { country: "Catar", code: "ar", flag: "qa.svg" },
      { country: "Bahrein", code: "ar", flag: "bh.svg" },
      { country: "Brunei", code: "ms", flag: "bn.svg" },
      { country: "Timor-Leste", code: "pt-BR", flag: "tl.svg" },
      { country: "Fiji", code: "en", flag: "fj.svg" },
      { country: "Papua Nova Guiné", code: "en", flag: "pg.svg" },
      { country: "Ilhas Salomão", code: "en", flag: "sb.svg" },
      { country: "Vanuatu", code: "en", flag: "vu.svg" },
      { country: "Samoa", code: "en", flag: "ws.svg" },
      { country: "Tonga", code: "en", flag: "to.svg" },
      { country: "Kiribati", code: "en", flag: "ki.svg" },
      { country: "Micronésia", code: "en", flag: "fm.svg" },
      { country: "Palau", code: "en", flag: "pw.svg" },
      { country: "Ilhas Marshall", code: "en", flag: "mh.svg" },
      { country: "Nauru", code: "en", flag: "nr.svg" },
      { country: "Tuvalu", code: "en", flag: "tv.svg" },
      { country: "Cazaquistão", code: "ru", flag: "kz.svg" },
      { country: "Uzbequistão", code: "ru", flag: "uz.svg" },
      { country: "Turcomenistão", code: "ru", flag: "tm.svg" },
      { country: "Quirguistão", code: "ru", flag: "kg.svg" },
      { country: "Tajiquistão", code: "ru", flag: "tj.svg" },
    ],
    mea: [
      { country: "Turquia", code: "tr", flag: "tr.svg" },
      { country: "Arábia Saudita", code: "ar", flag: "sa.svg" },
      { country: "Emirados Árabes", code: "ar", flag: "ae.svg" },
      { country: "Egito", code: "ar", flag: "eg.svg" },
      { country: "Israel", code: "he", flag: "il.svg" },
      { country: "Quênia", code: "sw", flag: "ke.svg" },
      { country: "Nigéria", code: "en", flag: "ng.svg" },
      { country: "África do Sul", code: "en", flag: "za.svg" },
      { country: "Etiópia", code: "am", flag: "et.svg" },
      { country: "Marrocos", code: "ar", flag: "ma.svg" },
      { country: "Gana", code: "en", flag: "gh.svg" },
      { country: "Argélia", code: "ar", flag: "dz.svg" },
      { country: "Tunísia", code: "ar", flag: "tn.svg" },
      { country: "Líbia", code: "ar", flag: "ly.svg" },
      { country: "Sudão", code: "ar", flag: "sd.svg" },
      { country: "Sudão do Sul", code: "en", flag: "ss.svg" },
      { country: "Somália", code: "sw", flag: "so.svg" },
      { country: "Tanzânia", code: "sw", flag: "tz.svg" },
      { country: "Uganda", code: "sw", flag: "ug.svg" },
      { country: "Ruanda", code: "sw", flag: "rw.svg" },
      { country: "Burundi", code: "sw", flag: "bi.svg" },
      { country: "Camarões", code: "fr", flag: "cm.svg" },
      { country: "Costa do Marfim", code: "fr", flag: "ci.svg" },
      { country: "Senegal", code: "fr", flag: "sn.svg" },
      { country: "Mali", code: "fr", flag: "ml.svg" },
      { country: "Burkina Faso", code: "fr", flag: "bf.svg" },
      { country: "Níger", code: "fr", flag: "ne.svg" },
      { country: "Chade", code: "ar", flag: "td.svg" },
      { country: "Rep. Centro-Africana", code: "fr", flag: "cf.svg" },
      { country: "Congo", code: "fr", flag: "cg.svg" },
      { country: "RD Congo", code: "fr", flag: "cd.svg" },
      { country: "Gabão", code: "fr", flag: "ga.svg" },
      { country: "Guiné Equatorial", code: "es", flag: "gq.svg" },
      { country: "São Tomé e Príncipe", code: "pt-BR", flag: "st.svg" },
      { country: "Lesoto", code: "en", flag: "ls.svg" },
      { country: "Eswatini", code: "en", flag: "sz.svg" },
      { country: "Botswana", code: "en", flag: "bw.svg" },
      { country: "Namíbia", code: "en", flag: "na.svg" },
      { country: "Zimbábue", code: "en", flag: "zw.svg" },
      { country: "Zâmbia", code: "en", flag: "zm.svg" },
      { country: "Malawi", code: "en", flag: "mw.svg" },
      { country: "Moçambique", code: "pt-BR", flag: "mz.svg" },
      { country: "Angola", code: "pt-BR", flag: "ao.svg" },
      { country: "Cabo Verde", code: "pt-BR", flag: "cv.svg" },
      { country: "Guiné-Bissau", code: "pt-BR", flag: "gw.svg" },
      { country: "Guiné", code: "fr", flag: "gn.svg" },
      { country: "Benim", code: "fr", flag: "bj.svg" },
      { country: "Togo", code: "fr", flag: "tg.svg" },
      { country: "Libéria", code: "en", flag: "lr.svg" },
      { country: "Serra Leoa", code: "en", flag: "sl.svg" },
      { country: "Gâmbia", code: "en", flag: "gm.svg" },
      { country: "Mauritânia", code: "ar", flag: "mr.svg" },
      { country: "Djibuti", code: "ar", flag: "dj.svg" },
      { country: "Eritreia", code: "ar", flag: "er.svg" },
      { country: "Comores", code: "ar", flag: "km.svg" },
      { country: "Madagascar", code: "en", flag: "mg.svg" },
      { country: "Maurício", code: "en", flag: "mu.svg" },
      { country: "Seychelles", code: "en", flag: "sc.svg" },
      { country: "Bahamas", code: "en", flag: "bs.svg" },
    ],
  };
